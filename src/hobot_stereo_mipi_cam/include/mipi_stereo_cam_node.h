...
private:
  ...
  rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr cam0_publisher_ = nullptr;
  rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr cam1_publisher_ = nullptr;
  ...
  // 是否发布拼接并压缩的图像
  bool do_pub_compressed_img = false;
  // 是否发布灰度图
  bool is_gray = false;
};
