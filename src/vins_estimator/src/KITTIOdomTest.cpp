...
int main(int argc, char **argv) {
    ...
    for (size_t i = 0; i < imageTimeList.size(); i++) {
        if (rclcpp::ok()) {
            ...
            sensor_msgs::msg::Image imLeftMsg;
            cv_bridge::CvImage(std_msgs::msg::Header(), "mono8", imLeft).toImageMsg(imLeftMsg);
            ...
            sensor_msgs::msg::Image imRightMsg;
            cv_bridge::CvImage(std_msgs::msg::Header(), "mono8", imRight).toImageMsg(imRightMsg);
