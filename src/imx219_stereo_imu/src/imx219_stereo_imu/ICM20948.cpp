...
void i2cInit(void)
{
  ...
  {
    RCLCPP_ERROR(rclcpp::get_logger("imx219_stereo_imu_node"),"Failed to open the i2c bus.\n");
  }
  return;
}
...
uint8_t I2C_ReadOneByte(uint8_t DevAddr, uint8_t RegAddr)
{
  ...
  {
    RCLCPP_ERROR(rclcpp::get_logger("imx219_stereo_imu_node"),"Failed to acquire bus access and/or talk to slave.\n");
    return 0;
  }
  write(fd, &RegAddr,1);
  read(fd, &u8Ret, 1);
